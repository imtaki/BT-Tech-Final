      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-wrap justify-between items-start">
          <div className="w-full md:w-1/3 mb-4 md:mb-0">
            <h2 className="text-sm font-bold uppercase tracking-wider mb-3 text-orange-500">
              Departments
            </h2>
          ...
          <div className="w-full md:w-1/3 mb-4 md:mb-0 flex flex-col items-center">
            <span className="font-bold text-orange-500">BOKU University</span>
            <span className="text-xs text-gray-500">Gregor-Mendel-Straße 33, 1180 Vienna, Austria</span>
            <a
              href="tel:+431476540"
              className="flex items-center gap-1 text-orange-500 hover:text-orange-600 transition-colors mt-1"
            >
          ...
          <div className="w-full md:w-1/3 flex justify-end">
            <Link
              className="flex items-center gap-1 bg-orange-400 text-white px-3 py-1 rounded hover:bg-orange-500 transition-colors text-sm"
              to="/login"
            >
              <IoKey /> Login
            </Link>
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.facebook.com/bokuvienna/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <FaFacebookSquare className="text-white hover:text-gray-200 transition-colors" />
            </a>
            <a href="https://www.instagram.com/boku.vienna/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <FaInstagram className="text-white hover:text-gray-200 transition-colors" />
            </a>
            <a href="https://www.youtube.com/user/bokuwien" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <FaYoutube className="text-white hover:text-gray-200 transition-colors" />
            </a>
            <a href="https://www.linkedin.com/school/bokuvienna/?originalSubdomain=at" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <FaLinkedin className="text-white hover:text-gray-200 transition-colors" />
            </a>
            <a href="https://www.tiktok.com/@bokuvienna" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              <FaTiktok className="text-white hover:text-gray-200 transition-colors" />
            </a>
          </div>
        </div>
      </div>
